...
use MyDpo\Http\Controllers\Auth\CustomersAnalizaGapCentralizatoareController;

Route::middleware('valid-customer')->prefix('/customer-analiza-gap')->group( function() {

    Route::middleware('is-activated')->get('/{customer_id}/centralizatoare', [CustomersAnalizaGapCentralizatoareController::class, 'index']);
