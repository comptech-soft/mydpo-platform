...
class TipCentralizator extends Model {
    ...
    public function RowsCountByUser($customer_id, $user) {
        $centralizatoare = Centralizator::where('customer_id', $customer_id)->where('centralizator_id', $this->id)->get();
...
}::where('customer_id', $customer_id)->where('centralizator_id', $this->id)->get();
